<template>
    <section v-if="!import.meta.env.SSR" class="bg-gray-50">
...
const faqs = [
    {
        ...
        answer:
            'For most types of massage therapy, the answer is usually yes, with Shiatsu being to exception to this rule. However, the amount of clothing you need to remove depends largely on the extent of the treatment you are receiving. For full body treatments, you should undress down to your pants at least, but most clients opt to remove all their clothes. Since no two therapists are alike. It is best to ask during the consultation what is preferred. You should be covered with towels or sheets. so the only parts showing are the parts being treated. This helps you to relax and helps to keep you warm.'
    },
    {
    ...
    },
    {
        ...
        answer:
            'Yes, massage therapists adhere to the following code: • We provide the test quality care to any one that seeks our professional help. • We accept all chants without discrimination • We acknowledge the confidential nature of the professional relationship with a chi respect each client’s right to privacy • We practice only the modalities in which we have been professionally trained and • We in no way participate or engage in arty type of sexual activities with our client. • We maintain a safe. clean and professional environment'
    },
    {
